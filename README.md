...
💻 Full-Stack Developer working with **React.js, Next.js, Node.js, Express.js, and PostgreSQL**.
...
### 💬 SidoSips — Real-Time Chat Application

A real-time chat application built with **React, Node.js, Express, PostgreSQL, and Socket.IO**.

Features include real-time messaging, online presence, responsive UI, and a WhatsApp-inspired chat experience.

🔗 [View Repository](https://github.com/sidraliaqat/sidosips-real-time-chat-app)
...
🔗 [View Repository](https://github.com/sidraliaqat/butterflyteam-Multi-Tenant-User-Management-System)

---

### 📊 InsightHub — Sales Management & BI System

A sales management and business intelligence system combining backend APIs, database management, and data visualization.

**Tech:** FastAPI • Next.js • SQL Server • Power BI

🔗 [View Repository](https://github.com/sidraliaqat/InsightHub)
...
<p align="center">
  <a href="https://www.linkedin.com/in/sidraliaqat">
